...
type
  Tfrmreport2 = class(TForm)
    ...
    CheckBox_remCTO: TCheckBox;
    db_remCTO: TRxDBLookupCombo;
    RadioButton_guiltyAll: TRadioButton;
    RadioButton_guilty: TRadioButton;
    RadioButton_Not_guilty: TRadioButton;
    RadioButton_injuredAll: TRadioButton;
    RadioButton_injured: TRadioButton;
    RadioButton_not__injured: TRadioButton;
    RadioGroup_guilty: TGroupBox;
    RadioGroup_injured: TGroupBox;
    ...
    procedure CheckBox_remCTOClick(Sender: TObject);

  private
    { Private declarations }
  public
    what:byte;
    procedure Expel_avto_1;
    procedure Expel_avto_2;
    procedure FinGsm;
    procedure Expel_pokaz2;
    procedure PlanExpel;
    procedure Shina;
    procedure ShinaRazmer;
    procedure ReportOil;
    procedure ReportDtp;
  protected
...
procedure Tfrmreport2.CheckBox_remCTOClick(Sender: TObject);
begin
if CheckBox_remCTO.Checked then
db_remCTO.Enabled:=true
else
db_remCTO.Enabled:=false;
end;
...
begin
    ...
    tPlaceRemont.Open;tPlaceRemont.Sort:='name';
end;
end;
...
if RadioButton_guiltyAll.Checked then guilty:=-1;
if RadioButton_guilty.Checked then guilty:=1;
if RadioButton_Not_guilty.Checked then guilty:=0;

if RadioButton_injuredAll.Checked then injured:=-1;
if RadioButton_injured.Checked then injured:=1;
if RadioButton_not__injured.Checked then injured:=0;

//if CheckBox_injured.Checked then injured:=1 else injured:=-1;
if (CheckBox_remCTO.Checked) and (db_remCTO.Text<>'') then id_rem_place:=db_remCTO.KeyValue else id_rem_place:=-1;
...
id_dislok,type_tc_p,-1,-1,-1,preserv_p,notATX,id_gsm,-1,'-1','-1',-1,-1,guilty, injured, id_rem_place,-1);
//Close;
end;
...
procedure Tfrmreport2.Expel_avto_1;
begin
what:=2;
d1L.Visible:=true;
d2L.Visible:=true;
...
numb1_edit.Enabled:=true;
Caption:='Выборка для отчета "Эксплуатационная карточка 1"';
end;
procedure Tfrmreport2.Expel_avto_2;
begin
what:=3;
d1L.Visible:=true;
d2L.Visible:=true;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
Source2_box.Checked:=true;
Source2_box.Enabled:=false;
db_source2.KeyValue:=dm.ado_source.Fields[0].AsInteger;
Caption:='Выборка для отчета "Эксплуатационная карточка 2"';
end;
procedure Tfrmreport2.Expel_pokaz2;
begin
what:=11;
d1L.Visible:=true;
d2L.Visible:=true;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
gsm_box.Visible:=true;
db_gsm.Visible:=true;

Caption:='Выборка для отчета "Эксплуатационные показатели"';
end;
procedure Tfrmreport2.ReportOil;
begin
what:=71;
d1L.Visible:=true;
d2L.Visible:=true;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
gsm_box.Visible:=false;
db_gsm.Visible:=false;

Caption:='Выборка для отчета "Отчет по маслу"';
end;
procedure Tfrmreport2.ReportDtp;
begin
what:=72;
d1L.Visible:=true;
d2L.Visible:=true;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
//TnotATX.Visible:=false;
gsm_box.Visible:=false;
db_gsm.Visible:=false;

RadioGroup_guilty.Visible:=true;
RadioButton_guiltyAll.Visible:=true;
RadioButton_guilty.Visible:=true;
RadioButton_Not_guilty.Visible:=true;
RadioGroup_injured.Visible:=true;
RadioButton_injured.Visible:=true;
RadioButton_injuredAll.Visible:=true;
RadioButton_not__injured.Visible:=true;
CheckBox_remCTO.Visible:=true;
db_remCTO.Visible:=true;


TnotATX.Top:=304;
RadioGroup_guilty.Top:=325;
RadioGroup_injured.Top:=325;
CheckBox_remCTO.Top:=400;
db_remCTO.Top:=404;

Caption:='Выборка для отчета "Отчет по ДТП"';
end;
procedure Tfrmreport2.PlanExpel;
begin
what:=12;
d1L.Visible:=false;
d2L.Visible:=false;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
Caption:='Выборка для отчета "Годовой план эксплуатации"';
end;
procedure Tfrmreport2.Shina;
begin
what:=13;
d1L.Visible:=false;
d2L.Visible:=false;
...
d2R.Visible:=false;
//State_box.Visible:=false;
State_box.Caption:='С превышением лимита';
OutAccount_box.Visible:=false;
life_box.Visible:=false;
Caption:='Выборка для отчета "Отчет по шинам"';
end;
procedure Tfrmreport2.ShinaRazmer;
begin
what:=73;
d1L.Visible:=false;
d2L.Visible:=false;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
Caption:='Выборка для отчета "Отчет по размерам шин"';
end;
procedure Tfrmreport2.FinGsm;
begin
what:=41;
d1L.Visible:=true;
d2L.Visible:=true;
...
OutAccount_box.Visible:=false;
life_box.Visible:=false;
reg_box.Visible:=false;
db_reg.Visible:=false;
div_box.Visible:=false;
db_div.Visible:=false;
pre_depart_box.Visible:=false;
db_pre.Visible:=false;
serv_box.Visible:=false;
db_serv.Visible:=false;
preserv_box.Visible:=false;
db_preserv.Visible:=false;
mark_box.Visible:=false;
db_mark.Visible:=false;
model_box.Visible:=false;
db_model.Visible:=false;
numb1_box.Visible:=false;
numb1_edit.Visible:=false;
numb2_box.Visible:=false;
numb2_edit.Visible:=false;
oldNumbBox.Visible:=false;
old_namb_text.Visible:=false;
year_box.Visible:=false;
Label1.Visible:=false;
year1.Visible:=false;
Label2.Visible:=false;
year2.Visible:=false;
vin_box.Visible:=false;
vin_edit.Visible:=false;
Neng_box.Visible:=false;
eng_edit.Visible:=false;
Nbody_box.Visible:=false;
body_edit.Visible:=false;
NShas_box.Visible:=false;
shas_edit.Visible:=false;
Npts_box.Visible:=false;
pts_edit.Visible:=false;
Source2_box.Visible:=false;
db_source2.Visible:=false;
Group_box.Visible:=false;
db_group.Visible:=false;
InAccount_box.Visible:=false;
...
Source1_box.Top:=56;
Source1_box.Left:=8;
Source1_box.Caption:='Бюджет';
db_source1.Top:=56;
db_source1.left:=128;
dislok_box.Visible:=false;
db_dislok.Visible:=false;




Caption:='Выборка для отчета "Финансирование ГСМ"';
end;
