...
for i:=0 to DBGrid_expl.Columns.Count-1 do
    ...
    Columns[3].Title.Caption:='Дата начала';
    Columns[4].Title.Caption:='Дата окончания';
    Columns[5].Title.Caption:='Вид ремонта';
        Columns[5].Width:=150;

    Columns[6].Title.Caption:='Сумма ремонт';
        Columns[6].Width:=100;
    Columns[7].Title.Caption:='Сумма запчастия';
        Columns[7].Width:=100;
    Columns[8].Title.Caption:='Сумма ТМЦ';
        Columns[8].Width:=100;
    Columns[9].Title.Caption:='Кол-во дней';
        Columns[9].Width:=100;


    Columns[10].Title.Caption:='Место ремонта';
        Columns[10].Width:=150;
    Columns[11].Title.Caption:='Спидометр на начало работ';
        Columns[11].Width:=200;
    Columns[12].Title.Caption:='Спидометр на следующее ТО';
        Columns[12].Width:=200;
    Columns[13].Visible:=false;
    Columns[14].Visible:=false;
    Columns[15].Title.Caption:='Малсо (л)';
        Columns[15].Width:=70;
end;
end;
...
for i:=0 to DBGrid_expl.Columns.Count-1 do
    ...
    Columns[0].Visible:=false;
    Columns[1].Visible:=false;
    Columns[2].Title.Caption:='№ заявки';
    Columns[3].Title.Caption:='Дата заявки';
    Columns[4].Title.Caption:='Показания спидометра';
    Columns[5].Title.Caption:='Водитель';
    Columns[6].Title.Caption:='Вид ТО';
    Columns[10].Title.Caption:='Организация';
...
SetTitleGrid3();
SetTitleCard('Заявочные карточки автотранспорта "'+mark+'"');
mark_avt:=mark;
DBGrid_expl.SetFocus;
end;
