...
begin
   ...
   begin
    ...
    ADOCom1.Parameters[9].Direction:=pdReturnValue;
      ...
      try
        ADOCom1.Execute;
        id_remont:=ADOCom1.Parameters[9].Value;
        CommitTR;
        ...
        begin
           ...
           begin
            if StoredProc1.Active then StoredProc1.Active:=false;
                ...
                StrFloatValue:=StringReplace(s1.Cells[1,i],'.',FormatSettings.DecimalSeparator,[rfReplaceAll, rfIgnoreCase]);
                StrFloatValue:=StringReplace(StrFloatValue,',',FormatSettings.DecimalSeparator,[rfReplaceAll, rfIgnoreCase]);
